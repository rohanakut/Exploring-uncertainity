...
##lines 16-25 are refered from the above mentioned website. From line 28 he entire code is written by me
...
for k in range(100):
    ...
    for i in range(len(values_mean)):
        entr.append(find_entropy(values_mean[i]))
