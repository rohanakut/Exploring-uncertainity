...
##lines 16-27 are refered from the above mentioned website. From line 30 he entire code is written by me
...
for k in range(50):
    ...
    for i in range(len(values_mean)):
        entr.append(find_var(values_mean[i])-entropy)
    ...
    print(score[1])
np.save('data_entr_cifar.npy', num_arr)
